        ...
        <div className="sm:px-10 lg:flex lg:justify-center">
          ...
          >
            ...
            <div className="px-4 pt-4 bg-gray-200 rounded-lg md:w-full">
              ...
              <p className="m-0 text-orange-600 text-4xl">
                399$
            ...
            <div className="p-4 border-t-2 border-b-2 bg-white md:w-full md:border-0">
              <ol className="font-semibold">
                <li className="my-2 md:flex">
                  <span className="mr-2 text-orange-600">&#8730;</span> 1 Meal
                  Everyday
                </li>
                <li className="my-2 md:flex">
                  <span className="mr-2 text-orange-600">&#8730;</span> Order
                  24/7
                </li>
                <li className="my-2 md:flex">
                  <span className="mr-2 text-orange-600">&#8730;</span> Access
                  to New Creations
                </li>
                <li className="my-2 md:flex">
                  <span className="mr-2 text-orange-600">&#8730;</span> Free
                  Delivery
                </li>
              </ol>
            </div>
