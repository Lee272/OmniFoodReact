  ...
  render() {
    ...
    return (
      <div className="py-10" id="SignUp">
        {/* HEADER */}
        <div>
          <h1 className="P-underline text-center text-3xl md:text-4xl">
          ...
          <div className="">
            ...
            <div className="md:flex items-center">
              <div className="md:mr-4">
                <label className="m-0 text-base font-semibold">Name:</label>
              </div>
              {/* FIRSTNAME INPUT */}
            ...
            <div className="md:flex md:items-center">
              <div className="my-3 md:mr-5">
                <label className="m-0 text-base font-semibold">Email:</label>
              </div>
            ...
            <div className="mb-4 mt-4 flex items-center">
              <label className="m-0 text-base font-semibold">Newsletter</label>
              <div className="ml-3 flex items-center">
                ...
                {this.state.isChecked && (
                  <div className="ml-2 p-1 bg-white rounded-lg shadow-md shadow">
                    <p className="ml-2 mb-0" id="Test" name="test" value="test">
            ...
            <div className="md:flex">
              ...
              <div className="h-full w-full">
                <input
                  className="w-full h-40 mt-2 border-gray-400 border-2 text-center"
                  type="textarea"
