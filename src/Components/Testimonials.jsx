        ...
        <div className="text-justify md:flex md:items-baseline lg:mx-8 md:text-sm">
          ...
          <div className="p-2 text-white md:w-1/3">
            ...
            <div className="m-3 flex items-center">
              <img className="w-12 h-12 rounded-full" src={User1} alt="User1" />
          ...
          <div className="p-2 text-white md:w-1/3 md:flex-1">
            ...
            <div className="m-3 flex items-center">
              <img className="w-12 h-12 rounded-full" src={User2} alt="User1" />
          ...
          <div className="p-2 text-white md:w-1/3 md:flex-1">
            ...
            <div className="m-3 flex items-center">
              <img className="w-12 h-12 rounded-full" src={User3} alt="User1" />
